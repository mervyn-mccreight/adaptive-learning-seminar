...
zu vermittelnden Inhalte dementsprechend anzupassen.

So wird ein Anwender, der bisher keine Erfahrungen mit einem Thema hat, nicht sofort
...
\begin{description}
  ...
  Vergleichbar ist dies mit einer typischen Situation, in der sich ein
  ...
  Kompetenz zu ziehen.
  Auf diese Weise versucht ein Intelligentes Tutorielles System ein Modell des
...
Das Intelligente Tutorielle System bietet dem Benutzer jedoch nur zu
der Bewertung seines Wissensstands passende Lernmaterialen an, um mit dem Lernen
...
definiertes Lernziel zu erreichen. Es handelt sich jedoch nicht um reine
...
reinen Präsentation der Lehrinhalte einige Fragen an den Lernenden stellen.
Die Antworten auf diese Fragen, die der Lernüberprüfung dienen, beeinflussen den weiteren
Verlauf des Lernkurses. Wichtig ist, dass lediglich der Ablauf des Lernkurses
beeinflusst wird. So wird ein Lehrinhalt bei unzureichendem Ergebnis in der Leistungsüberprüfung
so lange wiederholt, bis der Lernende dazu in der Lage ist, die Fragestellung korrekt zu beantworten.
...
hierbei die aus den offiziellen Fragebögen bekannten Fragen repetitiv präsentiert,
...
wie zum Beispiel den Kognitivismus zu berücksichtigen.
...
auf Basis der Analyse geeignete pädagogische Lernstrategien für den Lernenden einschlagen,
...
Das Wissensmodell wird häufig auch als Expertenmodul bezeichnet. Es repräsentiert den vollständigen
...
Das Wissen wird in drei unterschiedliche Kategorien unterteilt:
...
\begin{description}
  ...
  Das deklarative Wissen repräsentiert \glqq Wissen-Was\grqq{} -Wissen, oder auch Faktenwissen.
	Es handelt sich um Sachverhalte, die
	auswendig gelernt werden können. Beispiele sind die Anzahl der Wirbel einer menschlichen Wirbelsäule,
	oder das Faktum, dass \(1+1=2\) ist.
	Dieses Wissen kann durch verschiedene Formen repräsentiert werden.
  ...
  Prozedurales Wissen wird auch praktisches Wissen oder \glqq Wissen-Wie\grqq{} -Wissen genannt.
	...
	Man nehme als Beispiel die Lösung der Aufgabe \(15*25=?\).
	...
	mit Hilfe deren man dazu in der Lage ist, schriftlich zu multiplizieren.
	Wichtig ist, dass die Basis von prozeduralem Wissen immer deklaratives Wissen ist.
	Prozedulares Wissen vermittelt stets Regeln, die deklaratives Wissen, möglicherweise verknüpft, verwendet,
  ...
  Das heuristische Wissen beinhaltet im Wesentlichen Erfahrungswerte von Lehrenden.
	Es wird daher auch häufig Erfahrungswissen genannt.
	Es handelt sich hierbei um typische Handlungsempfehlungen, die einen Lernenden
	dabei unterstützen können, die richtige Herangehensweise an eine Problemstellung zu finden.
	Im Wesentlichen sind es Tipps, die sich im Laufe der Zeit als hilfreich erwiesen haben.
	\cite[S. 5ff]{nazemi2006konzeption}
\end{description}
...
In diesem Modell sind die Vorgehensweisen des Programms verborgen, mit deren Hilfe es dazu
in der Lage ist, eine Problemstellung zu lösen. Für den Lernenden sind lediglich
die Ergebnisse der Lösungen einsehbar. Dieses Modell hat keine Ambitionen, menschliche
Intelligenz nachzustellen. Der Vorteil ist die leichtere Umsetzung zur Lösung
...
den Lernenden Schritt für Schritt an die richtige Lösung heranzuführen.
\cite[S. 95ff]{euler2013}
...
Strukturell wird Wissen in der Regel in Form von semantischen Netzen modelliert.
...
Ein semantisches Netz kann man sich als Graphen vorstellen. Die Knoten des Graphen repräsentieren
 einzelne atomare Wissenseinheiten. Kanten, mit denen zwei Knoten verbunden werden können,
...
ist eine Voraussetzung. Solch eine Relation drückt aus, dass eine Wissenseinheit zwingend notwendig ist,
...
Passend zum Wissensmodell ist auch das Wissen des Lerners im Lernermodell in zwei Kategorien aufgeteilt.
Es handelt sich um deklaratives und prozedurales Wissen. Beides sind Arten von Wissen, die
in der Form auch im Wissensmodell bekannt sind.
...
Streng genommen wird lediglich notiert, ob der Lernende dieses Wissenselement optimal beherrscht, oder gar nicht.
...
\cite[S.21]{gonschorek1998wissensbasierte}
...
\cite[S.21ff]{gonschorek1998wissensbasierte}
...
Diesen Wissensstand erhält das Tutorenmodell über das Lernermodell.
...
Art und Weise angewendet wurden. Dabei führen oftmals mehrere verschiedene Lösungswege zu derselben korrekten Lösung.
Eine Methode um zu bewerten ob dieses Wissen korrekt angewandt wurde, ist das Model-Tracing.
...
Nun wird versucht, Schritt für Schritt mit Hilfe der bekannten und korrekten Regeln, den Lösungsweg des Lernenden nachzuvollziehen.
Hierfür wird ein Lösungswegbaum mit zielführenden Lösungswegen aufgebaut.
...
Problematisch ist, dass es für das System nicht möglich ist zu wissen, ob der Lernende seine Schritte
bewusst, oder durch Raten gewählt hat. Daher kann es auch zu Fehleinschätzungen seines Wissenstandes kommen.
...
Sie dient als Kommunikationsschnittstelle. Auf der Benutzerschnittstelle wird dem Lernenden das vom System bereitgestellte Wissen
präsentiert. Der Lernende bedient über die Benutzerschnittstelle das System. Je nach Art des Systems kann es sich um die reine
...
Typische Formen einer Benutzerschnittstelle sind die Kommunikation über Text und die Eingabe über die Kommandozeile oder auch ein
...
Im Folgenden sollen einige dieser Methoden beispielhaft vorgestellt werden.
...
Diese Form der Anpassung ist in Reinform nur an den Stellen möglich, an denen der Lernende selbst nicht die Navigation vornimmt.
\cite[S.17]{lehmann2010lernstile}
...
Die Zusatzinformationen können auf verschiedene Art und Weise
präsentiert werden. Es kann sich um rein angegebenes Wissen, oder auch um zusätztliche Fragen handeln, die den Lernenden
...
Diese Art der Adaption ist dann besonders nützlich, wenn Wissen, das zum Verständnis des zu vermittelnden neuen Wissens essentiell ist,
...
Informationen, die in reiner Textform übermittelt werden besonders effektiv, während andere eine bildliche Präsentation bevorzugen.
...
als ungeeignet eingestuft werden, vor dem Benutzer versteckt. Die Modifikation bezieht sich also auf die Auswählbarkeit der Navigation.
...
Eine andere Form der Anpassung ist die Veränderung der Reihenfolge der Navigationsinhalte.
Folgeschritte, die als besonders geeignet angesehen werden, werden an einer attraktiveren Stelle platziert als
schlechter geeignete Fortsetzungen. Auf diese Weise wird der Lerner auf einem optimalen Lernweg gehalten.
\cite[S.17]{lehmann2010lernstile}
