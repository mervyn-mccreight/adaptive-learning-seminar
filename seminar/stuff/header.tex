...
%% Document properties %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\projname}{Seminar Adaptives Lernen}
\newcommand{\titel}{E-Learning und Wissenskommunikation}
\newcommand{\authorname}{Mervyn Kilian McCreight}
\newcommand{\thesisname}{Seminar}
\newcommand{\untertitel}{Adaptives Lernen}
\newcommand{\Datum}{14. Juli 2016}
